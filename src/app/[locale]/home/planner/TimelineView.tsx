...
const categoryTokens = {
  MEETUP: {
    ...
    btnBg: "bg-indigo-600 dark:bg-indigo-500",
    btnHover: "hover:bg-indigo-700 dark:hover:bg-indigo-400",
    btnOutlineHoverBg: "hover:bg-indigo-500/10 dark:hover:bg-indigo-400/10",
  ...
  EXPO: {
    ...
    btnBg: "bg-violet-600 dark:bg-violet-500",
    btnHover: "hover:bg-violet-700 dark:hover:bg-violet-400",
    btnOutlineHoverBg: "hover:bg-violet-500/10 dark:hover:bg-violet-400/10",
  ...
  FOOD: {
    ...
    btnHover: "hover:bg-amber-700 dark:hover:bg-amber-400",
    btnOutlineHoverBg: "hover:bg-amber-500/10 dark:hover:bg-amber-400/10",
  ...
  PARTY: {
    ...
    btnBg: "bg-pink-600 dark:bg-pink-500",
    btnHover: "hover:bg-pink-700 dark:hover:bg-pink-400",
    btnOutlineHoverBg: "hover:bg-pink-500/10 dark:hover:bg-pink-400/10",
    hoverText: "group-hover:text-pink-600 dark:group-hover:text-pink-300",
  ...
  TRAVEL: {
    ...
    btnBg: "bg-emerald-600 dark:bg-emerald-500",
    btnHover: "hover:bg-emerald-700 dark:hover:bg-emerald-400",
    btnOutlineHoverBg: "hover:bg-emerald-500/10 dark:hover:bg-emerald-400/10",
  ...
  TOURNAMENT: {
    ...
    btnBg: "bg-rose-600 dark:bg-rose-500",
    btnHover: "hover:bg-rose-700 dark:hover:bg-rose-400",
    btnOutlineHoverBg: "hover:bg-rose-500/10 dark:hover:bg-rose-400/10",
