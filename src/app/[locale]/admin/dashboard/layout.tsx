    ...
    <div className="flex h-screen min-h-screen">
      <aside className="h-screen w-48 shrink-0 border-r bg-background/60 backdrop-blur supports-[backdrop-filter]:bg-background/40 overflow-y-auto">
        <div className="p-4 border-b">
          <h2 className="text-sm font-semibold tracking-wide uppercase text-muted-foreground">Admin</h2>
        </div>
      ...
      <SidebarInset className="flex-1 overflow-auto p-0">{children}</SidebarInset>
    </div>
  );
}
